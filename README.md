...
```bash
npm i fca-shadow-remake
```
or
```bash
npm install fca-shadow-remake
```
...
```bash
npm install fca-shadow-remake@latest
```
Hoặc
```bash
npm i fca-shadow-remake@latest
```
...
```javascript
const login = require("fca-shadow-remake"); // lấy từ lib ra 
...
```js
    var login = require('fca-shadow-remake')
```
...
```js
const fs = require("fs");
const login = require("fca-shadow-remake");
